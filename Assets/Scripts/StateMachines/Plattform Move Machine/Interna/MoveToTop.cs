...
{
    public class MoveToTop : StateMachineBehaviour
    {
        ...
        override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
        {
            ...
            animator.SetBool("ReachTop", false);
            m_movingVector = animator.gameObject.GetComponent<PlattformMoving>().GetMovingVector(2);
            m_endPositionTop = animator.gameObject.GetComponent<PlattformMoving>().GetEndPosition(2);
        ...
        override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
        {
            ...
            if (!isWayLeft)
            {
                animator.SetBool("ReachTop", true);
            }
            else
            {
